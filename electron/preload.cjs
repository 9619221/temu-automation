...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  yunqiDb: {
    ...
    selectionAdd: (params) => ipcRenderer.invoke("yunqi-db:selection-add", params),
  ...
  erp: {
    ...
    temuOpenApi: {
      ...
      listSales: () => ipcRenderer.invoke("erp:temu-openapi:sales"),
      listRecords: (source) => ipcRenderer.invoke("erp:temu-openapi:records", { source }),
    },
    user: {
    ...
    supplier: {
      ...
      goods: (params) => ipcRenderer.invoke("erp:supplier:goods", params || {}),
    },
    sku: {
    ...
    reports: {
      ...
      goodsDataSnapshot: (options) => ipcRenderer.invoke("erp:reports:goods-data-snapshot", options || {}),
      ...
      firstShipToday: (options) => ipcRenderer.invoke("erp:reports:firstship-today", options || {}),
      goodsCreatedToday: (options) => ipcRenderer.invoke("erp:reports:goods-created-today", options || {}),
  ...
  app: {
    ...
    getExtensionDirectory: () => ipcRenderer.invoke("app:get-extension-directory"),
    ...
    openPdf: (payload) => ipcRenderer.invoke("app:open-pdf", payload),
