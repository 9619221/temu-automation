...
export default function AlibabaMapping() {
  ...
  const previewSpecsFromUrl = useCallback(async () => {
    ...
    try {
      ...
      form.setFieldsValue({
        ...
        supplierName: detail.supplierName || values.supplierName || undefined,
        productTitle: detail.productTitle || values.productTitle || undefined,
        imageUrl: detail.imageUrl || values.imageUrl || undefined,
  ...
  const applySelectedUrlSpec = useCallback(() => {
    ...
    form.setFieldsValue({
      ...
      supplierName: urlSpecDialog.detail.supplierName || values.supplierName || undefined,
      productTitle: urlSpecDialog.detail.productTitle || values.productTitle || undefined,
      imageUrl: imageValue([selected.imageUrl, urlSpecDialog.detail.imageUrl, values.imageUrl]) || undefined,
