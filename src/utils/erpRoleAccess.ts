...
const ROUTE_ROLES: Record<string, string[]> = {
  ...
  "/sourcing-center": ["admin", "manager", "operations", "buyer"],
  "/purchase-center": ["admin", "manager", "operations", "buyer", "finance"],
  "/auto-purchase": ["admin", "manager", "operations"],
  "/auto-ship-map": ["admin", "manager", "operations"],
  ...
  "/selection-plaza": ["admin", "manager", "operations"],
